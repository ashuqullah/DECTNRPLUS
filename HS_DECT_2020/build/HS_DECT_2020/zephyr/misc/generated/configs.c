...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CARRIER, 1677);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NETWORK_ID, 91);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TX_POWER, 13);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TX_TRANSMISSIONS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RX_PERIOD_S, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_PHY_HELLO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DECT_PHY_HELLO_LOG_LEVEL, 3);
