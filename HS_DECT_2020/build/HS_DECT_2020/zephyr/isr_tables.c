...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x1087d, (ISR)0x16de7}, /* 42 */
	...
	{(const void *)0x1063d, (ISR)0x16de7}, /* 49 */
