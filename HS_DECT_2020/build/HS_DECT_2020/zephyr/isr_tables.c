...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x105ad, (ISR)0x16b07}, /* 42 */
	...
	{(const void *)0x1036d, (ISR)0x16b07}, /* 49 */
