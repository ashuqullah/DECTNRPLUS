...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x1047d, (ISR)0x169d7}, /* 42 */
	...
	{(const void *)0x1023d, (ISR)0x169d7}, /* 49 */
