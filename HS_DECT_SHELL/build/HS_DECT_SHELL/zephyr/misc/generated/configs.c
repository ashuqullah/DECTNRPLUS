...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_STACK_SIZE, 9216);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_SHMEM_CTRL_SIZE, 0x728);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_SHMEM_TX_SIZE, 15360);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_SHMEM_RX_SIZE, 6144);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GETOPT_LIB, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LINK_BINARY_DECT_PHY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_SHMEM_CTRL_SIZE, 0x728);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_SERIAL_RX_RING_BUFFER_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_CMD_BUFF_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_ARGC_MAX, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESH_PRINT_BUFFER_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESH_DECT_PHY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DESH_STARTUP_CMDS, 1);
