...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x25ea9, (ISR)0x3222d}, /* 42 */
	...
	{(const void *)0x25b8d, (ISR)0x3222d}, /* 49 */
